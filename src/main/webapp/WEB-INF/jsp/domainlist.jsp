		...
		<table class="table table-striped mg-b-0 text-md-nowrap">
			...
			<tr> 
				...
				<!-- 페이징처리 part2/2-->	
				    ...
				    <li>
				        <a href='<c:url value="/domainlist/${pageMaker.startPage-1}"/>'><i class="fa fa-chevron-left"></i></a>
				    </li>
				    </c:if>
				    ...
				    <li>
				        <a href='<c:url value="/domainlist/${pageNum}"/>'><i class="fa" style="color:OrangeRed;">${pageNum}</i></a>
				    </li>	    
				    </c:when>    
				    <c:otherwise>		       
				    <li>
				        <a href='<c:url value="/domainlist/${pageNum}"/>'><i class="fa">${pageNum}</i></a>
				    </li>			    
				    </c:otherwise>
					</c:choose>	    
				    </c:forEach>
				    ...
				    <li>
				        <a href='<c:url value="/domainlist/${pageMaker.endPage+1}"/>'><i class="fa fa-chevron-right"></i></a>
				    </li>
				    </c:if>
					</ul>
